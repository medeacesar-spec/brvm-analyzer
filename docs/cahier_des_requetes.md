...
| 33 | **Sonatel — les capitaux propres 2025 sont rangés sur l'exercice 2026.** Le 6 septembre, les capitaux propres consolidés ont été portés à 1 274,6 Md (2024) et 1 399,3 Md (2025) (voir « Fait »). Aujourd'hui : 2024 = 1 274,6 ✓ ; **2025 = 1 001,9 Md** (ligne modifiée le 17/09) ; **2026 = 1 398,9 Md** (ligne du 14/09), alors que l'exercice 2026 n'est pas clos. Le document 2025, lu en mode sûr, donne 1 399,263. Quel traitement a déplacé la valeur ? | à instruire |
